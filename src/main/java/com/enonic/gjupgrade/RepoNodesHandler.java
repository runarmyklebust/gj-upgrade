...
import com.enonic.gjupgrade.model.UpgradeExportProperties;
...
public final class RepoNodesHandler
{
    ...
    private void log()
    {
        this.upgradeModels.forEach( UpgradeModel::log );
    }
    ...
    private void processRepositories( final Path path )
    {
        ...
        try (final Stream<Path> repositories = IOHelper.getChildren( path ).filter( IGNORE_FILES_FILTER ))
        {
